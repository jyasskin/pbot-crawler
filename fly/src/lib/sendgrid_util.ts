...
sendgrid;
const debug=debugModule('pbotcrawl:sendgrid');
`
import Set from typing;
import cast from python_http_client.client;
import Response from sendgrid;
import SendGridAPIClient from sendgrid.helpers.mail;
from collections.abc import(Content, From, Mail, Personalization,
    ReplyTo, Subject,
...
function get_pbot_subscribers() -> list{
    response = cast(
        Response,
