import { cleanContent } from "@lib/html_processor";
...
describe("cleanContent", () => {
  ...
  test("class", () => {
    expect(
      cleanContent(
        String.raw`<div><div class="view view-alerts view-id-alerts view-display-id-block_1 js-view-dom-id-7503104ea1e14d980b278a1c110c9c073814c27f5e798af57e6a23495726f168">`,
      ),
    ).toEqual(
      String.raw`<div><div class="view view-alerts view-id-alerts view-display-id-block_1 ">`,
    );
  });
